package com.event4u.systemevents.grpc;
...
public final class actionGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.event4u.systemevents.grpc.Event4U.Request,
      com.event4u.systemevents.grpc.Event4U.APIResponse> getLogActionMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "logAction",
      requestType = com.event4u.systemevents.grpc.Event4U.Request.class,
      responseType = com.event4u.systemevents.grpc.Event4U.APIResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.event4u.systemevents.grpc.Event4U.Request,
      com.event4u.systemevents.grpc.Event4U.APIResponse> getLogActionMethod() {
    io.grpc.MethodDescriptor<com.event4u.systemevents.grpc.Event4U.Request, com.event4u.systemevents.grpc.Event4U.APIResponse> getLogActionMethod;
      ...
      synchronized (actionGrpc.class) {
        if ((getLogActionMethod = actionGrpc.getLogActionMethod) == null) {
          actionGrpc.getLogActionMethod = getLogActionMethod = 
              io.grpc.MethodDescriptor.<com.event4u.systemevents.grpc.Event4U.Request, com.event4u.systemevents.grpc.Event4U.APIResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "action", "logAction"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.event4u.systemevents.grpc.Event4U.Request.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.event4u.systemevents.grpc.Event4U.APIResponse.getDefaultInstance()))
  ...
  public static abstract class actionImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void logAction(com.event4u.systemevents.grpc.Event4U.Request request,
        io.grpc.stub.StreamObserver<com.event4u.systemevents.grpc.Event4U.APIResponse> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                com.event4u.systemevents.grpc.Event4U.Request,
                com.event4u.systemevents.grpc.Event4U.APIResponse>(
  ...
  public static final class actionBlockingStub extends io.grpc.stub.AbstractStub<actionBlockingStub> {
    ...
    /**
     */
    public com.event4u.systemevents.grpc.Event4U.APIResponse logAction(com.event4u.systemevents.grpc.Event4U.Request request) {
  ...
  public static final class actionFutureStub extends io.grpc.stub.AbstractStub<actionFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.event4u.systemevents.grpc.Event4U.APIResponse> logAction(
        com.event4u.systemevents.grpc.Event4U.Request request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LOG_ACTION:
          serviceImpl.logAction((com.event4u.systemevents.grpc.Event4U.Request) request,
              (io.grpc.stub.StreamObserver<com.event4u.systemevents.grpc.Event4U.APIResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class actionBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.event4u.systemevents.grpc.Event4U.getDescriptor();
    }
